...
Lift.get("/getDoctor",authMiddleware,Get_doctor_details)
Lift.put("/updateDoctor/:id",authMiddleware,Update_doctor)
Lift.post("/addDoctor",authMiddleware,Add_doctor)
Lift.delete("/deleteDoctor/:id",authMiddleware,Delete_doctor)
